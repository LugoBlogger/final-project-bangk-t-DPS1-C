...
class TFLiteClassifier(private val context: Context) {
    ...
    private fun initializeInterpreter() {
        ...
        val model = loadModelFile(assetManager, "com/example/handsigndetection/model/classif_preTrained.tflite")

        labels = loadLines(context, "com/example/handsigndetection/model/labels.txt")
